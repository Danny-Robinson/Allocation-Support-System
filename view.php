...
class view {
	...
	// drop down boxes to select students 
?><html>
<form action="#" method="post">

<?php
// ...................................session to be selected....................................... 
...
?>
	<select name="student1" ID="student1"  onChange="buttonChange()" >
<?php 
	}
	if (count($sessionsToFill) > 1){
?>
...
$_SESSION['ids'] = $id;
header('Location: displayFullWeek.php');
	}
	
?></html><?php
	}
	// add data needed to display allocations
