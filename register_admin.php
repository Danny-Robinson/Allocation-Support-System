<?php
	...
	echo "You are registering <strong>Admin staff</strong><br>";			
	...
	$location = 'register_admin.php';
	
	$acc_type = 0;
	
	//Define the output log file for debugging purposes
	$file = 'log_reg_admin.txt';
	...
	$insert_error=$_GET["insert_error"]; //the insert error is either "" (if this page is hit for the first time or no DB insertion errors occurred) or "The Administrator <Administrator's full name> already exists!" 
	...
	if (isset($_POST['btn_reg_submit'])) {
  		...
  		do {	
			...
			try {
				...
				//insert the new staff member to the Admin table
