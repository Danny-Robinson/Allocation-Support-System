<?php
	...
	/* STAFF DELETED CONFIRMATION  */
	


	$header = 'Staff Deleted'; /* use this variable to set the header string */
	...
	if ($staff_ID != "") {
		...
		$conn = NULL;
		echo "<br><span class = \"info\"> $forename $surname has been successfully deleted </span><br>";
		
	} else {
		
		echo "<br><span class = \"error\"> ERROR: No staff has been deleted (staff ID has not been specified)</span><br>";
	}
